...
module.exports = {
    pluginOptions: {
      electronBuilder: {
        ...
        removeElectronJunk: false,//电子的垃圾端子输出
        externals: [], //这里是你使用的原生模块名字列表，改成自己的即可
        nodeModulesPath: ['../../node_modules', './node_modules','../node_modules'],//这里是多个node_modules路径，按自己需要配置即可
        //打包配置
        builderOptions: {
            "appId": "com.hsp_queuingup_plus.app",
            "productName":"排队叫号系统",//项目名，也是生成的安装文件名，即aDemo.exe
